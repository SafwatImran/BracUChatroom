...
public class addCourse extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(47, 47, 47)
                        .addComponent(courseName, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(119, 119, 119)
    ...
    private void submitNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitNameActionPerformed
        try {
            ...
            String sql = "CREATE TABLE " + courseName.getText()
                    + "(id INTEGER not NULL, "
                    + " stdName VARCHAR(255), "
                    + " stdId VARCHAR(255), "
                    + " stdEmail INTEGER, "
            ...
            JFrame f = new JFrame();
            JOptionPane.showMessageDialog(f, "New course created");
